...
export default function ProceduresByUnitLinkSection() {
  ...
  return (
    <Collapsible defaultOpen={false} id="section-procedimento-unidade">
      ...
      >
        {/* Header */}
        <div className="min-w-[40rem] grid grid-cols-[3rem_1fr_1fr_5rem_5rem_5rem_2rem] gap-2 px-3 py-1 items-center">
        ...
        {isLoading ? (
          ...
          (items as UnitProcedureLink[]).map((item) => (
            <div
              key={item.id}
              className="min-w-[40rem] grid grid-cols-[3rem_1fr_1fr_5rem_5rem_5rem_2rem] gap-2 items-center rounded-lg px-3 py-2 border border-border"

...
import { ChevronDown, Plus, Trash2, UserCog } from "lucide-react";
...
export default function ServicesByProfessionalSection() {
  ...
  return (
    <Collapsible defaultOpen={false} id="section-servicos-profissional">
      ...
      >
        {/* Header */}
        <div className="min-w-[28rem] grid grid-cols-[1fr_1fr_auto_2rem] gap-2 px-3 py-1 items-center">
        ...
        {isLoading ? (
          ...
          (items as ProfessionalProcedure[]).map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="min-w-[28rem] grid grid-cols-[1fr_1fr_auto_2rem] gap-2 items-center rounded-lg px-3 py-2 border border-border"

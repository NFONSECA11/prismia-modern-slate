...
import { ChevronDown, Plus, Trash2, ClipboardList } from "lucide-react";
...
export default function ProceduresByUnitSection() {
  ...
  return (
    <Collapsible defaultOpen={false} id="section-procedimentos-unidade">
      ...
      >
        {/* Header */}
        <div className="min-w-[44rem] grid grid-cols-[3rem_1fr_1fr_5rem_5rem_5rem_auto_2rem] gap-2 px-3 py-1 items-center">
        ...
        {anyLoading ? (
          ...
          allProcedures.map((proc) => {
            ...
            return (
              <div
                key={proc.id}
                className="min-w-[44rem] grid grid-cols-[3rem_1fr_1fr_5rem_5rem_5rem_auto_2rem] gap-2 items-center rounded-lg px-3 py-2 border border-border"

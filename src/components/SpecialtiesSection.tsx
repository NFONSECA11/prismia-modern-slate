...
export default function SpecialtiesSection() {
  ...
  return (
    <Collapsible defaultOpen={false} id="section-especialidades">
      ...
      >
        {/* Header */}
        <div className="grid grid-cols-[5rem_3rem_1fr_8rem_auto_2rem] gap-2 px-3 py-1 items-center">
        ...
        {isLoading ? (
          ...
          (items as Specialty[]).map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="grid grid-cols-[5rem_3rem_1fr_8rem_auto_2rem] gap-2 items-center rounded-lg px-3 py-2 border border-border"

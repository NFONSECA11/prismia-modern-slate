...
export function BookingDrawer({ booking, onClose, onConfirmed }: BookingDrawerProps) {
  ...
  const isBotOn = (forceBotOff || isCancelCode) ? false : (effectiveBotMode === "on" || (effectiveBotMode !== "off" && effectiveStatus !== "handoff" && effectiveStatus !== "awaiting_choice" && effectiveStatus !== "pending"));

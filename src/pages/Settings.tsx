...
export default function Settings() {
  ...
  return (
    <div className="min-h-screen relative" style={{ background: mainBg }}>
      ...
      <header
        className="app-safe-area-top sticky top-0 z-30 flex items-center gap-3 px-3 sm:px-6 py-3"
      ...
      <main className="px-3 sm:px-6 py-6 max-w-3xl mx-auto space-y-6 relative z-10">

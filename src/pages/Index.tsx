  ...
  return (
    <div className="min-h-screen relative" style={{ background: mainBg }}>
      ...
      <div className="print:hidden relative -mb-3">
        <div
          className="inline-flex items-center gap-2 px-4 md:px-4 px-2.5 py-1 pr-10 md:pr-10 pr-8 relative mt-1"
          style={{
      ...
      <main className={`relative z-10 ${zenMode ? "hidden" : ""} ${view === "agenda" ? "px-2 pt-5 pb-2 space-y-2" : "px-6 py-5 space-y-5 max-w-[1440px]"} mx-auto`}>

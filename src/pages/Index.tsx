...
export default function Index() {
  ...
  return (
    <div className="min-h-screen relative" style={{ background: mainBg }}>
      ...
      <main className={`relative z-10 ${zenMode ? "hidden" : ""} ${view === "agenda" ? "px-0.5 sm:px-6 pt-1 sm:pt-5 pb-1 space-y-1 sm:space-y-2" : "px-0.5 sm:px-6 py-1 sm:py-5 space-y-1 sm:space-y-5"} max-w-[1440px] mx-auto`}>
